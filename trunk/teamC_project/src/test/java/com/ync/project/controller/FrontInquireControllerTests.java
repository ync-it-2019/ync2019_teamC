...
@Log4j
public class FrontInquireControllerTests {
...
//
//		log.info(
//				mockMvc.perform(MockMvcRequestBuilders.get("/shop/inquire/package1-inquire"))
//				.andReturn()
//				.getModelAndView()
//				.getModelMap());
//	}
...
//	}
	...
	public void testListPaging() throws Exception {
		...
		log.info(mockMvc.perform(
				MockMvcRequestBuilders.get("/shop/inquire/package1-inquire")
				.param("pageNum", "1")
				.param("amount", "10"))
				.andReturn()
				.getModelAndView()
