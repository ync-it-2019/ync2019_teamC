...
<div id="wrapper">
    ...
    <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                ...
                <th>가격</th>
						...
						<td><fmt:formatDate pattern="yyyy-MM-dd" value="${manage.departure_date}"/></td>
						<td><fmt:formatDate pattern="yyyy-MM-dd" value="${manage.arrival_date}"/></td>
						<td><c:out value="${manage.transportation}"/></td>
						<td><c:out value="${manage.theme}"/></td>
						<td><c:out value="${manage.costprice}"/></td>
						</tr>
						</c:forEach>
						</tbody>
					</table>
        ...
        <form id='actionForm' action="/admin/product_manage" method='get'>
...
<script type="text/javascript">
  $(document).ready(function() {
	  ...
	  $("#regBtn").on("click", function() {
		  self.location = "/admin/product_manage";
	  });
