		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-맛집1.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">La Petite Rose des Sables</h2>
						<p>할아버지가 주방에서 요리를 하시고 할머니가 작은 홀은 맡으시는, 프랑스 전통 가정식입니다. 저렴한 가격에
							프랑스 전통 음식들을 맛볼 수 있습니다.</p>
					</div>
				</div>
				<hr>
				<!-- Second Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-맛집2.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">Le Bouillon Chartier</h2>
						<p>100년 전통의 역사를 자랑하는 인기있는 프렌치 레스토랑입니다. 달팽이 요리(Escargot,
							에스까르고)와 푸아그리 요리로 유명하여 줄을 서서 먹을 정도로 현지인들에게도 유명한 맛집입니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-맛집3.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">Le Cinq</h2>
						<p>프랑스 파리에 위치한 포시즌 호텔에 있는 레스토랑으로 미슐랭가이드에서 별 3개를 받은 정통 프렌치를 맛 볼
							수 있는 곳이다. 생화를 이용한 장식으로 화려하면서도 고풍스러운 분위기와 친절하고도 유쾌한 서비스로 즐거운 시간을
							보낼 수 있다. 드레스코드가 정해져 있으며 남성은 자켓은 대여를 해주기도 한다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-맛집4.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">Multari</h2>
						<p>다소 투박한 모양의 빵들이지만, 본연의 맛으로 호감이 가는 빵집이다. 바게트, 크로와상, 빵오쇼콜라가
							인기있으며, 머랭과 마들렌도 먹음직스럽다.</p>
					</div>
				</div>
				<hr>
			</div>
