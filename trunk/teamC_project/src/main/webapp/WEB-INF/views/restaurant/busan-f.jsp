		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/부산-맛집1.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">장수삼</h2>
						<p>우리 장수삼은 여러분들을 위하는 마음으로 정성을 다한 음식으로 저와 제가족들도 잘먹습니다. 맛나게 기분좋게
							드시고 가셔서 하시는 모든일들이 잘 되십시오. 손님 여러분들께서 저희 장수삼 을 찾아주셔서 감사합니다. 우리의
							장수삼은 화려하거나 고급스럽지 않고 메뉴 또한 다양하지 않습니다. 그냥(아주) 소박합니다. 편하게 오셔서 맛있게
							드시고 기분좋게 가셔서 (또) 오는 집입니다. 생각만 하셔도 (설렘)이 있는 곳입니다</p>
					</div>
				</div>
				<hr>
				<!-- Second Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/부산-맛집2.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">더파티 해운대점</h2>
						<p>더파티는 고객이 원하는 가치, 그 이상을 창조하는 미래지향적인외식문화 공간입니다.전문쉐프가 만드는 글로벌한
							프리미엄급 메뉴와 사랑을 실천하는 세심한 서비스기품이느껴지는 안락한 분위기로 고객의 미소는 더파티의 자부심입니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/부산-맛집3.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">알리아농</h2>
						<p>프랑스의 대표 음식인 닭요리, 갓 구워낸 빵, 숙성된 와인, 싱싱한 해산물을 대표하는 알리아농은 신선한
							식자재를 이용한 다채로운 요리를 선보입니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/부산-맛집4.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">삼오정</h2>
						<p>50년간 여러분의 입맛을 지켜온 정성,따뜻하고 다정한 그 맛을 삼오정의 그릇마다 오롯이 담았습니다. 최고의
							휴식은 맛있게 차려진 식사를 가족, 친구, 등 다양한 사람들과 나누는 것 입니다.잘 먹은 한 그릇이 마음과 몸을
							유연하게 하고 바쁜 일상에 쉼표 하나를 다는 것과 같습니다. 삼오정은 맛있는 한 그릇으로 여러분께 맛을 즐기고 나누는
							기쁨을 함께하고 싶습니다.</p>
					</div>
				</div>
				<hr>
