		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/영국-맛집1.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">제이미 올리버</h2>
						<p>제이미 올리버는 TV프로그램에 출연하면서 대중적인 요리로 세계적으로 유명해진 요리사입니다. 그의 레스토랑은
							이스 링턴 오래 된 거리에 있는 '비영리'레스토랑입니다. 비행청소년에게 요리법을 가르쳐 바른 길로 인도해주는 일도
							하고 있다네요.</p>
					</div>
				</div>
				<hr>
				...
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/영국-맛집2.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">Alain Ducasse at The Dorchester</h2>
						<p>Alain Ducasse는 전 세계에서 인정받는 셰프 중 한 분이다. 이곳에서는 현대와의 조화를 이룬
							완벽한 프랑스 요리를 맛 볼 수 있다. 정통한 점심 식사를위한 완벽한 장소인 레스토랑은 와인, 물, 커피를 포함한
							세가지 코스 세트 메뉴를 제공합니다. 또한 특별한 경우에는 조용하고 개인적인 공간을 사용할 수 있습니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/영국-맛집3.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">더락&소울플레이스</h2>
						<p>현지인들에게 더욱 인정 받고 있는 피쉬앤칩스 전문점입니다. 런던의 유명한 잡지마다 늘 베스트 레스토랑에
							이름을 올릴 만큼 인기가 많으며, 두꺼운 대구(Cod)가 유명합니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/영국-맛집4.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">베이글 베이크</h2>
						<p>겉보기에는 허름해 보이지만 런던 사람들의 사랑을 꾸준히 받고 있는 베이글 가게.</p>
					</div>
				</div>
				<hr>
			</div>
