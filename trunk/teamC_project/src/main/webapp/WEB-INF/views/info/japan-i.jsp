		...
		<!-- Page Content -->
			...
			<div class="row">
				<article class="col-md-8">
							<h1 class="page-header sidebar-title">일본 소개</h1>
							<!-- 슬라이드 쇼-->
							<div class="slideshow-container">

<div class="mySlides fade">
	<div class="numbertext">1 / 3</div>
	<img src="/resources/img/일본-소개1.jpg" style="width:100%">
</div>

<div class="mySlides fade">
	<div class="numbertext">2 / 3</div>
	<img src="/resources/img/일본-소개2.jpg" style="width:100%">
</div>

<div class="mySlides fade">
	<div class="numbertext">3 / 3</div>
	<img src="/resources/img/일본-소개3.jpg" style="width:100%">
</div>
</div>
<br>
...
<!-- 슬라이드 쇼-->
			        <hr>
					<p>일본국(日本国) 또는 일본(日本)은 동아시아의 동쪽 끝과 오세아니아의 북쪽에 위치한 일본 열도를 통치하는 나라이다.</p></br>
					<p>일본 열도는 혼슈, 규슈, 시코쿠, 홋카이도 등 주요 네 섬과 부속 도서로 이루어져 있다.
						공식 국호인 일본국은 1945년 포츠담 선언에 서명한 이후 1947년에 시행된 일본국 헌법에 의해 성립되었다. </p></br>
					<p>일본은 정치적으로는 양원제 의원내각제인 입헌군주제를 채택하고 있다. 이에 헌법 1조에 따라 '일본국의 상징'
						이며 '일본 국민 통합의 상징'이자 동시에 국가원수의 직무(국사행위)를 맡는 천황과, 국민의 선거를 통해 선출되며 참의원(상원),
						 중의원(하원)으로 구성되는 일본 국회가 병존한다. 정부의 수반은 국회의원 가운데에서 선출되는 내각총리대신이 맡으며, 일본의 총리는
						  국가행정의 책임자로서 내각부를 구성하고 중앙성청을 지휘한다. 현재의 천황은 나루히토, 국회의 집권여당은 자유민주당이며
							 내각총리대신은 아베 신조이다. </p>
			    </article>
					<!-- Blog Sidebar Column -->
					<aside class="col-md-4 sidebar-padding">
							...
							<div class="blog-sidebar">
									...
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/일본-패키지1.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">오사카 맛집, 전통의맛</h4>
													일본하면 떠오른 음식들! 이 음식들의 본고장은 대부분 오사카이다.
													 전통이 깊은 오사카의 음식들은 매우 다양한 방법과 맛으로 발전해왔고 지금도 끊임없이 발전하며 널리 퍼져 나가고 있다.
													본고장에서 먹는 음식은 분명히 다른 맛! 오사카에서만 맛볼 수 있는 진짜를 느껴보자.
											</div>
									</div>
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/일본-패키지2.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">후쿠오카 근교여행 - 유후인, 벳푸, 구로카와</h4>
													후쿠오카 시내로는 만족 못 하겠다는 여행자를 위한 추천 여행지 세 곳을 소개한다.
													유후인, 벳푸, 구로카와 모두 후쿠오카에서 쉽고 빠르게 갈 수 있는 근교 여행지.
													산큐패스로 큐슈 고속버스 예약 시 한국어로도 서비스 중으로 초심자도 걱정하지 말고 이용해 보자.
											</div>
									</div>

									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/일본-패키지3.jpg" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">일본 속 일본 풍경</h4>
													일본 고유의 정취를 느낄 수 있는 공간이 있다! 황궁과 신사, 절이 도심 속에 남아 특유의 정적인
