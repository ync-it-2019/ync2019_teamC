...
<!-- 슬라이드 쇼-->
					...
					<p>경상북도 동남부에 위치한 시. 동남쪽으로 동해, 서쪽에는 영천시 및 청도군, 남쪽으로 울산광역시, 북쪽에
						포항시와 접하고 있다. 신라시대에는 서라벌이라고 불렸고 천년의 고도(古都)였으며, 조선 시대에는 안동시와 함께
						 유네스코 세계문화유산 양동마을을 위시한 영남 남인의 구심 도시이기도 했다. 수많은 문화재가 있는 동시에 한국
						  유수의 관광도시다.</p></br>
					<p>신라의 수도로 남북국시대 때는 인구 수십만명이 살았을 것이라고 추정되고 있고 고려 초중기에도 동경이라는
						 명칭을 썼을 정도였으며, 고려 후기에 무신정권에 대항하는 반란이 일어나고 나서는 3경에서 제외되고 이어서
						  몽골의 침략으로 황폐화되었지만 어느 정도 재건이 된 다음에는 계림부로 불렸다. 조선시대에도 경상도의 경자가
							 경주에서 따왔고 부로 지정되는 등 현대의 광역시급 지위는 되었을 정도로 경상도에서 가장 큰 도시 중
							 하나였다.</p></br>
					<p>한국의 시 중 면적이 2번째로 넓다. 참고로 1위는 같은 경상북도의 안동시이고, 3위 역시 경상북도인 상주시이다.
						 그래서 경상북도가 도 중에서 면적이 가장 넓은 것이다.</p>
			    </article>
					<!-- Blog Sidebar Column -->
					<aside class="col-md-4 sidebar-padding">
							...
							<div class="blog-sidebar">
									...
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/경주-패키지1.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">혼자서도 잘 먹어요, 나 홀로 맛집</h4>
													누군가에게 방해받지 않고 오롯이 자신만을 위해 떠나는 나홀로 여행. 고즈넉함을 즐기기 좋은
													경주이기 때문인지 유독 혼자 다니는 여행객이 많은 곳이기도 하다.
													  난 절대 쓸쓸하지 않아! 당당하게 경주의 맛있는 식사를 즐기자.
											</div>
									</div>
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/경주-패키지2.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">살아있는 역사 박물관</h4>
													도시 곳곳에 산재하는 각종 유물들, 그야말로 경주는 살아 있는 박물관!
													살아 있는 노천 박물관 경주를 제대로 즐기기 위해서는 당연히 예습이 필요할 터!
													자신에게 꼭 맞는 프로그램을  알아둔다면 경주 여행이 한결 즐거울 것!
											</div>
									</div>

									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/경주-패키지3.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">경주의 아름다운 카페</h4>
													문화재만 가득할 것이라는 경주의 이미지는 이제 버려도 좋다.
													경주에도 낭만과 감성이 가득한 카페들이 늘어나고 있어 현재는 경주에 오면 반드시 들러야 하는
													곳 중 하나로 자리잡았다. 마음에 쏙 드는 카페를 골라 찾아가보자.
											</div>
									</div>
							</div>
