	...
	<div class="container blog singlepost">
		<div class="row">
			<article class="col-md-8">
				...
				<!-- 슬라이드 쇼-->
				<hr>
				<p>중화인민공화국 또는 중국은 동아시아에 있는 공산주의 국가이다. 수도는 베이징 이며, 일반적으로 동아시아의
					국가로 간주되지만, 영토가 넓어 중앙아시아와 동남아시아 부근에도 영토가 걸쳐 있다</p>
				</br>
				<p>세계에서 가장 많은 14억여 명의 인구를 가졌고, 표준중국어를 주 언어로 사용하며 간자체 한자를 사용한다.
					국가 면적 크기는 3~4위인데, 미국과 거의 차이가 없어 분쟁지역의 포함 여부나 '영토 개념'의 해석상의 차이로 통계에
					따라 서로 순위가 달라지기도 한다. 이에 대해서는 중국/자연지리를 참조. 유럽연합 전체 면적보다 2배 이상 더 크다.</p>
				</br>
				<p>경제면에서 PPP 경제력(구매력 기준 GDP)은 미국을 능가하였고(1위), GDP 경제력(명목 GDP)은
					미국의 60%를 넘는(2위) 경제대국이다. 동시에 무역 규모에서는 세계 1위로 미국을 능가하였다. 외환보유고 1위의
					국가이며 금 보유고는 6위고 이런 면모 때문에 중국은 하나의 국가를 넘어, 하나의 문화권 그 자체로 봐야 한다는 말도
					있다.</p>
			</article>
			<!-- Blog Sidebar Column -->
