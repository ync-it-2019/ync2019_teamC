...
<!-- 슬라이드 쇼-->
			        <hr>
					<p>이탈리아 공화국 또는 이탈리아는 남유럽에 위치한 반도 국가이다.
					반도의 모양이 장화와 비슷한 것으로 유명하다. 지중해와 아드리아해에 접해 있다. 수도는 로마.
					 로마 제국의 중심지였던 국가라 고대 유럽 문화의 핵심이었고 라틴 문자의 발상지다.</p></br>
					<p>북서쪽은 프랑스, 북쪽은 스위스, 오스트리아, 북동쪽은 슬로베니아와 육지로 국경을 접하고 있고,
						 직접 국경을 접하고 있진 않지만 이탈리아와 가깝고 바다만 건너면 닿는 주변국들로 동쪽은 아드리아해
						  건너편의 발칸 반도에 속한 크로아티아, 보스니아 헤르체고비나, 몬테네그로, 남동쪽은 알바니아, 그리스,
							 남쪽은 몰타, 남서쪽은 알제리, 튀니지, 서쪽은 스페인이 있다.</p></br>
					...
					<aside class="col-md-4 sidebar-padding">
							...
							<div class="blog-sidebar">
									...
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/이탈리아-패키지1.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">작지만 큰 나라 바티칸 시국</h4>
													1929년 무솔리니와 교황청과의 협약인 라테란 조약으로 성립된 나라이다. 이전에는 이탈리아 반도의
													 중부에 교황령의 영토가 존재했으나 대부분은 이탈리아 왕국에 흡수되었었다. 로마 교황이 국가원수로서
													  절대적인 권한을 가진 나라다. 바티칸의 역사를 알아보자
											</div>
									</div>
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/이탈리아-패키지2.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">피자, 파스타 맛집</h4>
												면의 유래를 따질 때 빼놓을 수 없는 나라가 중국이다. 이렇듯 파스타의 유래도 설이 다르다.
												 기원전 5000년경 이탈리아 남쪽 해안에 살았던 민족이 다양한 모양의 파스타를 요리해 먹었다는 이야기가 있다.
											</div>
									</div>

									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/이탈리아-패키지3.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">로마패스 72시간권으로 떠나는 로마</h4>
													로마는 발 닿는 곳이 모두 역사고 유적지. 워낙 많은 유적지와 미술관, 박물관들이 곳곳에 있어 문화를
													 사랑하는 사람이라면 다 방문하고 싶을 것. 하지만 한정된 시간과 체력이 어쩔 수 없다면,
													  최대한 효율적으로 돌아다니는 것을 찾아 보자.
											</div>
									</div>
							</div>
