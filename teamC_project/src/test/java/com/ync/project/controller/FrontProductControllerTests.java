...
@Log4j
public class FrontProductControllerTests {
...
//		log.info(
//				mockMvc.perform(MockMvcRequestBuilders.get("/shop/shop"))
//				.andReturn()
//				.getModelAndView()
//				.getModelMap());
//	}
...
//
//		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/shop/review")
//				.param("product_num", "1"))
//				.andReturn()
//				.getModelAndView()
//				.getModelMap());
