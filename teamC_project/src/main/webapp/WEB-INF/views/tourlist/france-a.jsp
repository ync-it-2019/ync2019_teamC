		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-관광지1.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">에펠 탑</h2>
						<p>파리의 상징 인 에펠 탑은 세계에서 가장 유명한 명소 중 하나입니다. 이 독착서으이 위업은 1889년 세계
							박람회의 임시 전시로 구스타브 에펠(Gustave Eiffel)에 의해 설계된 8,000개의 금속 부품 으로 이루어진
							구조입니다. 구조의 독특한 우아함은 "Iron Lady"라는 별명을 얻었습니다. 방문객들은 탑의 기념 비적 인 크기와
							3단계의 각각의 숨막히는 전경을 감살 할 수 있습니다.</p>
					</div>
				</div>
				<hr>
				<!-- Second Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-관광지2.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">루브르 박물관</h2>
						<p>프랑스 왕의 오아궁에서 루브르 박물관은 최고의 유럽 미술 컬렉션 중 하나로 꼽히는 비교할 수 없는 박물관
							입니다. 많은 서양 문명의 가장 유명한 작품들이 여기에 있습니다. 루브르 박물관은 무수한 명화를 포함하여 3만점의
							놀라운 작품을 소장하고 있습니다. 하루 또는 심지어 일주일에 모든것을 볼 수는 없습니다. 가장 보람있는 경험울 위한
							주요 작품의 선정 명단에 중점을 둡니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-관광지3.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">배르사유 궁전</h2>
				...
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/프랑스-관광지4.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">몽생 미셸</h2>
						<p>몽생 미셸은 노르망디 해안의 바다에서 극적으로 상승하여 프랑스에서 가장 눈에 띄는 명소 중 하나이다. 이
							"바다의 피라미드"는 바위가 많은 ㅅ머에 자리 잡은 신비한 광경이며 벽과 요새로 둘러싸여 있습니다. 11세기에 세워
							졌기 때문에 수도원 교회는 중요한 순례지 였습니다. 그 영혼을 고무시키는 평온함 때문에 몽생 미셸은 "하늘의
							예루살렘"으로 알려져 있습니다.</p>
					</div>
				</div>
				<hr>
				...
				<div class="blog-sidebar">
					...
					<div class="media">
						<img class="img-responsive media-object"
							src="/resources/img/프랑스-패키지1.JPG" alt="Media Object">
						<div class="media-body">
							</br>
							<h4 class="media-heading">베르사유 궁전</h4>
							베르사유 궁전은 프랑스뿐만 아니라 유럽에서 가장 아름다운 궁전으로 뽑히는 곳으로, 죽기 전에 꼭 가봐야 하는 세계
							100대 명소 중 한 군데이다. 제대로 보기 위해서는 꼬박 하루를 소요해야 할 정도로 크고 볼거리가 많다.
						</div>
					</div>
					<div class="media">
						<img class="img-responsive media-object"
							src="/resources/img/프랑스-패키지2.JPG" alt="Media Object">
						<div class="media-body">
							</br>
							<h4 class="media-heading">철학가와 예술가들이 사랑한 카페</h4>
							파리에 가면 잊지 말고 꼭 해봐야 하는 것이 있다. 바로 노천 카페에 앉아 여유롭게 커피 마시기! 파리지앵 하면 가장
							먼저 떠오르는 모습이다. 카페 테라스에 앉아 에스프레소 한 잔과 함께 신문, 잡지를 보거나 지인과 두런두런 이야기를
							나누며 한가로운 오후를 보내는 것. 파리 여행에서 꿈꾸는 낭만 중 하나이다.
						</div>
					</div>

					<div class="media">
						<img class="img-responsive media-object"
							src="/resources/img/프랑스-패키지3.JPG" alt="Media Object">
						<div class="media-body">
							</br>
							<h4 class="media-heading">파리 여행, 현지투어로 편하게 즐기자!</h4>
							영어도 잘 통하지 않고, 관광객이 많아 호객꾼과 소매치기도 많고. 하지만 볼거리는 많아서 이곳저곳 둘러봐야 하는
							파리를 놓치고 싶지 않다면? 간편하게 현지투어를 즐기는 건 어떨까? 워낙 많은 관광객이 파리로 모여들기 때문에
							한국인이 운영하는 현지투어사도 많고, 파리 현지인들이 운영하는 현지투어를 즐길 수도 있다.
						</div>
					</div>
				</div>
