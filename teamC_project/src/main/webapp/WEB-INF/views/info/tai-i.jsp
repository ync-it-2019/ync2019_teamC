	...
	<div class="container blog singlepost">
		<div class="row">
			<article class="col-md-8">
				...
				<!-- 슬라이드 쇼-->
				<hr>
				<p>동남아시아에 위치하고 있는 국가, 수도는 방콕. 현재는 시암(BTS 시암역)이라는 이름을 가진 구역이 방콕의
					중심지를 이루고 있다.</p>
				</br>
				<p>국토가 적도 근방에 위치한 데다 모양도 은행잎처럼 위는 넓고 아래는 매우 좁고 긴 형태이기 때문에 지도상으로는
					그닥 넓어보이지 않지만, 남한 영토의 5배에 이르며 프랑스와 유사한 크기다. 제국주의 시대에 동남아시아에서 유일하게
					독립을 유지한 국가이기도 하다. 불과 150여 년 전만 해도 프랑스와 영국을 합친 것보다 넓었지만, 제국주의 시절 국가의
					독립을 위해 오늘날에는 라오스와 캄보디아에 속하는 영토를 전략적으로 프랑스에 식민지로 할양하여 지금의 형태가 되었다.</p>
				</br>
				<p>여전히 주변국인 라오스, 캄보디아, 미얀마(옛 버마)에 미치는 문화적, 경제적 영향이 크다. 지리적으로 봐도
					내륙국인 라오스, 소국인 캄보디아, 말라카 해협으로 인해 왠지 고립되어 보이는 미얀마를 잇는 가교 역할을 할 수 있으며
					경제적으로도 이들 나라들의 경제에 미치는 영향이 크다.</p>
			</article>
			<!-- Blog Sidebar Column -->
			<aside class="col-md-4 sidebar-padding">
				...
				<div class="blog-sidebar">
					...
					<ul class="sidebar-list">
						<li><a href="/info/tai-i.html">추천맛집</a></li>
						<li><a href="/tourlist/tai-a.html">추천관광지</a></li>
						<li><a href="/restaurant/tai-f.html">추천맛집</a></li>
					</ul>
				</div>
				<!-- Recent Posts -->
				<div class="blog-sidebar">
