		...
		<!-- Page Content -->
			...
			<div class="row">
				<article class="col-md-8">
							<h1 class="page-header sidebar-title">독일 소개</h1>
							<!-- 슬라이드 쇼-->
							<div class="slideshow-container">

<div class="mySlides fade">
	<div class="numbertext">1 / 3</div>
	<img src="/resources/img/독일-소개1.jpg" style="width:100%">
</div>

<div class="mySlides fade">
	<div class="numbertext">2 / 3</div>
	<img src="/resources/img/독일-소개2.jpg" style="width:100%">
</div>

<div class="mySlides fade">
	<div class="numbertext">3 / 3</div>
	<img src="/resources/img/독일-소개3.jpg" style="width:100%">
</div>
</div>
<br>
...
<!-- 슬라이드 쇼-->
			        <hr>
					<p>도이칠란트 연방공화국 또는 독일은 중부유럽에 위치한 국가이자 서유럽에 포함되기도 하는 국가다.</p></br>
					<p>시계 방향으로 북쪽은 덴마크, 동쪽은 폴란드, 체코, 남동쪽은 오스트리아,[10] 남서쪽은 스위스, 프랑스,
						 서쪽은 룩셈부르크, 벨기에, 네덜란드와 국경을 맞댄다. 북동쪽은 발트해, 북서쪽은 북해와 접해 있다.
						  수도는 베를린.</p></br>
					<p>유럽에서 가장 규모가 큰 경제 강국으로, 프랑스와 함께 현 유럽연합의 체제를 이끄는 국가다.
					국제통화기금 투표권은 세계 4위, AIIB 지분율은 세계 4위, 금보유고는 세계 2위다. 국방비는 세계 9위,
					 무기 수출은 세계 5위다.</p>
			    </article>
					<!-- Blog Sidebar Column -->
					<aside class="col-md-4 sidebar-padding">
							...
							<div class="blog-sidebar">
									...
									<ul class="sidebar-list">
											<li><a href="/info/ger-i.html">독일소개</a></li>
											<li><a href="/tourlist/ger-a.html">추천관광지</a></li>
											<li><a href="/restaurant/ger-f.html">추천맛집</a></li>
									</ul>
							</div>
							<!-- Recent Posts -->
							<div class="blog-sidebar">
									...
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/독일-패키지1.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">로만틱가도 2박 3일 여행</h4>
													남부 독일의 가장 널리 알려진 아름다운 도로 "로만틱 가도"를 따라 독일의 문화, 역사, 음식,
													 예술과 독일인들의 삶을 체험하는 코스입니다. 마인강에서 알프스에 이르는 로만틱가도를
													  2박3일 혹은 3박 4일 일정으로 둘러 보실 수 있습니다.
											</div>
									</div>
									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/독일-패키지2.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">낭만의 도시 하이델베르그 1일 투어</h4>
													하이델베르크는 독일을 대표하는 대학자 칸트, 헤겔, 괴테의 흔적이 살아 숨쉬는 인문학의 도시이자
													 독일을 대표하는 관광도시입니다. 또한 독일에서 손꼽히는 대학도시로서 도시의 전체적인 분위가 젊고
													  자유분방하며, 이에 수많은 관광객이 어우러져 있습니다.
											</div>
									</div>

									<div class="media">
													<img class="img-responsive media-object" src="/resources/img/독일-패키지3.JPG" alt="Media Object">
											<div class="media-body"></br>
													<h4 class="media-heading">라인강변1일투어</h4>
													라인강변의 양편으로 펼쳐지는 아름다운 풍경과 고성들을 감상하며 영화 "장미의 이름"의 촬영장소로
													 유명한 시토회 에버바흐 수도원, 리슬링포도주의 슈페트레세(Spätlese)
													 그리고 라인강의 슬픈 전설 "로렐라이언덕" 등을 둘러 보시는 1일 여행입니다.
											</div>
									</div>
							</div>
