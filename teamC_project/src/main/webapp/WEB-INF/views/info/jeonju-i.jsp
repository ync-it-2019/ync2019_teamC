	...
	<div class="container blog singlepost">
		<div class="row">
			<article class="col-md-8">
				...
				<!-- 슬라이드 쇼-->
				<hr>
				<p>전라북도 중앙부에 위치한 시. 전라북도청 소재지이자 전북 최대도시다. 동쪽으로는 완주군과 접하고 서남쪽 으로는
					김제시와 완주군 이서면과 접하고 북쪽으로는 익산시와 접한다. 시 인구와 동 지역 인구로는 비수도권 시급 기초자치단체
					중에서 창원시, 청주시에 이어 3위이다.</p>
				</br>
				<p>조선 왕조의 발상지라 '풍패지향(豊沛之鄕)'이라고도 불렸는데, 태조 이성계의 본관이 전주(전주 이씨)이기
					때문. 그래서 전주는 사대문에 풍(豊)자와 패(沛)자가 들어간다. 이성계의 실제 출생지는 함경도 영흥이지만 조선 왕조는
					왕조의 발상지를 전라도 전주로 한다. 조경단(肇慶壇)이 있는 건지산(乾止山)은 조선 왕실의 지중한 영내(領內)로써
					한그루의 나무, 한포기 풀잎도 함부로 못다루던 금역지대이다.</p>
				</br>
				<p>조선의 뿌리가 되는 도시로 여겨져 꽤 유명하며, 특히 일본에서는 서울특별시, 부산광역시 다음으로 인지도가 있는
					듯하다. 한국적인 도시라는 이미지가 있다. 전주에 들어오는 톨게이트도 한옥, 톨게이트를 지나 전주를 들어오는 관문은
					상술한 '호남제일문' 이라는 한옥문이 맞이한다. 전주역 또한 한옥의 모습이다. 또한 한국적, 여유, 예술 등 다소
					부드러운 이미지가 있다.</p>
			</article>
			<!-- Blog Sidebar Column -->
			<aside class="col-md-4 sidebar-padding">
				...
				<div class="blog-sidebar">
					...
					<ul class="sidebar-list">
						<li><a href="/info/jeonju-i.html">전주소개</a></li>
						<li><a href="/tourlist/jeonju-a.html">추천관광지</a></li>
						<li><a href="/restaurant/jeonju-f.html">추천맛집</a></li>
					</ul>
				</div>
				<!-- Recent Posts -->
				<div class="blog-sidebar">
