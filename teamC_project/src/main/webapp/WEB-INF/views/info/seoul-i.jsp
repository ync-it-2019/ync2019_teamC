	...
	<div class="container blog singlepost">
		<div class="row">
			<article class="col-md-8">
				...
				<!-- 슬라이드 쇼-->
				<hr>
				<p>서울특별시는 대한민국의 수도이자 대한민국 17개 광역자치단체 중 하나이다. 줄여서 서울이라고도 한다.</p>
				</br>
				<p>서울특별시는 지방자치법의 특별법으로 규정되어 있는 법률상 대한민국 제1의 도시다. 현재 대한민국에서 유일하게
					특별시이며, 수장인 서울특별시장은 대한민국의 광역자치단체장 중 유일하게 장관급 대우를 받는다. 북한까지 포함해 봐도,
					북한의 최대 도시 평양의 인구가 300만 명밖에 되지 않아 서울은 명실상부한 한반도의 종주도시라고 할 수 있다.</p>
				</br>
				<p>한성백제 때는 한강 이남 지역이 493년간 백제의 수도였으며, 한강 이북은 고구려 북한산군, 신라 한양군을
					거쳐 고려시대 때 개경 이남의 남경이었다. 조선시대 때는 505년 동안 조선의 수도 한성이었고, 이어 대한민국 시대에
					수도인 서울로서 지위를 차지하는 도시이다. 1950년대부터 1980년대까지 지방 이주민과 해외교포들의 서울 유입으로 매우
					활발한 인구증가를 보였던 탓에 도시권이 아닌 행정구역 기준으로도 세계 10대 도시에 들었던 적도 있었다. 수도권에
					집중되었던 개발정책에 1990년대 이후로 전국 주요 도시들이 쇠락하며 상대적으로 서울의 지위가 더욱 높아져 한국의 정치,
					교육, 문화, 경제를 완전히 주도하는 형국이다.</p>
			</article>
			<!-- Blog Sidebar Column -->
			<aside class="col-md-4 sidebar-padding">
				...
				<div class="blog-sidebar">
					...
					<ul class="sidebar-list">
						<li><a href="/info/seoul-i.html">서울소개</a></li>
						<li><a href="/tourlist/seoul-a.html">추천관광지</a></li>
						<li><a href="/restaurant/seoul-f.html">추천맛집</a></li>
					</ul>
				</div>
				<!-- Recent Posts -->
				<div class="blog-sidebar">
