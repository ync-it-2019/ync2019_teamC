	...
	<div class="container blog singlepost">
		<div class="row">
			<article class="col-md-8">
				...
				<!-- 슬라이드 쇼-->
				<hr>
				<p>홍콩(香港)은 중화인민공화국의 특별행정구로 광둥 성 주장 강 삼각주 하구에 위치한다. 1841년부터 영국의
					식민지(영국령 홍콩)였다가 1997년 중국으로 반환되었다. 이후 특별행정구가 설치되어 오늘에 이른다.</p>
				</br>
				<p>까우룽 반도(九龍半島, Kowloon, 보통화로는 주룽)와 홍콩 섬(香港島, Hong Kong Island,
					보통화로는 샹강다오)을 비롯한 여러 개의 섬으로 이루어져 있다. 광둥 성(廣東省) 선전(深圳)과 마주보는 지점에 있고,
					또다른 특별행정구인 마카오(澳門)에서도 그리 멀지 않다. 홍콩 표준시(GMT+8)는 대한민국 표준시보다 1시간이 느리다.
					중국 대륙(본토) 및 대만 섬과는 시간대를 공유한다.</p>
				</br>
				<p>아시아의 금융, 물류허브이자 쇼핑의 메카. 인구는 약 720만 명이고 면적은 1104km2(서울의
					1.82배)로 인구 밀도가 정말 높다. 1km2에 6천 명 정도가 거주한다. 다만 홍콩 섬 북단과 까우룽 반도 남부
					정도가 초고밀도로 개발되어 있고 나머지 지역(신계)은 인구밀도가 비교적 낮다.</p>
			</article>
			<!-- Blog Sidebar Column -->
