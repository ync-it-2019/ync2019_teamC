	...
	<div class="container blog singlepost">
		<div class="row">
			<article class="col-md-8">
				...
				<!-- 슬라이드 쇼-->
				<hr>
				<p>그레이트 브리튼 및 북아일랜드 연합왕국 또는 영국은 서유럽의 북해의 서쪽에 위치한 국가이다. 수도는 런던이며
					영어로는 흔히 United Kingdom, UK, Britain으로 줄여 부른다. 올림픽 등의 스포츠에서는 다소
					부정확하지만 관행상 Great Britain이라고 부른다.</p>
				</br>
				<p>한때는 해가 지지 않는 나라라는 별명이 있었다. 19~20세기 대영제국의 영토가 절정에 달했을 때 언제나
					제국의 어딘가는 낮이었기 때문이다. 아직도 해외 영토들이 남아있기 때문에 해가 지지 않는 국가는 맞다. 아일랜드 해를
					사이에 두고 아일랜드와 근접해 있고 도버 해협을 사이에 두고서는 프랑스의 칼레와 마주보고 있다. 영국 본토인 그레이트
					브리튼 섬과 아일랜드 섬 동북부에 걸쳐 있고 면적은 243,610 km²다.</p>
				</br>
				<p>현재의 네 개의 독립적인 지역이 연합한 영국이라는 국가는 생긴지 얼마 되지 않았다. 현재 영토가 확정된 것은
					1922년으로 아일랜드 자유국이 생겨난 후다. 뒤이어 식민지들의 독립으로 대영제국이 해체되고 지금의 영국이 탄생하게 된
					것이다.</p>
			</article>
			<!-- Blog Sidebar Column -->
