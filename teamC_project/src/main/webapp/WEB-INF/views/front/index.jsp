...
<!-- Chocolat-CSS -->
<link rel="stylesheet" href="/resources/css/chocolat.css"	  type="text/css" media="all">
...
<body>
<!--Header-->
<div class="header" id="home" style="height:50px">
      <div class="menubar">
				...
				<ul class="rslides" id="slider">
					<li>
						...
						<div class="slider-info">
							...
							<h3>S Trip you can go everywhere</h3>
					...
					<li>
						...
						<div class="slider-info">
							...
							<h3>S Trip can enjoy your trup </h3>
							<p>more information about your trip</p>
						</div>
					</li>
					<li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Snow Zone</h4>
										<img src="/resources/img/bann2.jpg" alt=" " class="img-responsive">
										<h5>Lorem Ipsum</h5>
...
<div class="container">
		<div class="w3-agile-about-grids">
			<div class="col-md-6 about-left-grid">
				<h4>INTRODUCE</h4>
				<h3>ABOUT OUR <span>S TRIP</span></h3>
...
<div class="container">
	...
	<div class="col-md-7 w3-services-grids">
		<div class="w3-services-grids-left">
			<div class="col-md-6 w3-services-grid-icon1 w3-border-bootom1">
			<h3><span><i class="fa fa-home" aria-hidden="true"></i></span>Housing</h3>
			<p>Nunc neque mi, scelerisque et ex ut, ultricies ultrices orci. Sed dignissim, metus a vestibulum pharedir</p>
			</div>
			<div class="col-md-6 w3-services-grid-icon-text w3-border-bootom2">
			<h3><span><i class="fa fa-plane" aria-hidden="true"></i></span>Travel</h3>
			<p>poly neque mi, scelerisque et ex ut, ultricies ultrices orci. Sed dignissim, metus a vestibulum pharedum</p>
			</div>
			<div class="clearfix"></div>
		</div>
			<div class="w3-agile-grid-left-bottom">
			<div class="col-md-6 w3-services-grid-icon1 w3-border-left">
			<h3><span><i class="fa fa-users" aria-hidden="true"></i></span>Agents</h3>
			<p>murc neque mi, scelerisque et ex ut, ultricies ultrices orci. Sed dignissim, metus a vestibulum pharetrp</p>
			</div>
			<div class="col-md-6 w3-services-grid-icon-text w3-border-left">
			<h3><span><i class="fa fa-star" aria-hidden="true"></i></span> Trip</h3>
			<p>Nasr neque mi, scelerisque et ex ut, ultricies ultrices orci. Sed dignissim, metus a vestibulum pharemom</p>
			</div>
			<div class="clearfix"></div>
			</div>
	</div>
		<div class="col-md-5 w3-services-grids-right">
		</div>
		<div class="clearfix"></div>
	</div>
</div>
<!--//services-->
	...
	<div class="wthreelocationsaits" id="locations">
		...
		<div class="location-w3-head">
			...
			<section class="grid3d vertical" id="grid3d">
				<div class="grid-wrap">
					<div class="grid">
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l2.jpg" alt="Odyssey"><figcaption><h4>SWITZERLAND</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l1.jpg" alt="Odyssey"><figcaption><h4>ITALY</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l3.jpg" alt="Odyssey"><figcaption><h4>GERMANY</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l4.jpg" alt="Odyssey"><figcaption><h4>FRANCE</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l5.jpg" alt="Odyssey"><figcaption><h4>MONACO</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l6.jpg" alt="Odyssey"><figcaption><h4>SPAIN</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l7.jpg" alt="Odyssey"><figcaption><h4>NORWAY</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l8.jpg" alt="Odyssey"><figcaption><h4>NETHERLANDS</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="/resources/img/l91.jpg" alt="Odyssey"><figcaption><h4>SWEDEN</h4></figcaption></figure>
					</div>
				</div>
				<div class="content">
					<div>
						<div class="dummy-img dummy-img-1"><img src="/resources/img/l2.jpg" alt="Odyssey"></div>
					...
					<div>
						<div class="dummy-img dummy-img-2"><img src="/resources/img/l1.jpg" alt="Odyssey"></div>
						<p class="dummy-text aitsheadingw3">ITALY</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-3"><img src="/resources/img/l3.jpg" alt="Odyssey"></div>
						<p class="dummy-text aitsheadingw3">GERMANY</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-4"><img src="/resources/img/l4.jpg" alt="Odyssey"></div>
						<p class="dummy-text aitsheadingw3">FRANCE</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-5"><img src="/resources/img/l5.jpg" alt="Odyssey"></div>
						<p class="dummy-text aitsheadingw3">MONACO</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-6"><img src="/resources/img/l6.jpg" alt="Odyssey"></div>
						<p class="dummy-text aitsheadingw3">SPAIN</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-7"><img src="/resources/img/l7.jpg" alt="Odyssey"></div>
						<p class="dummy-text aitsheadingw3">NORWAY</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-8"><img src="/resources/img/l8.jpg" alt="Odyssey"></div>
						<p class="dummy-text aitsheadingw3">NETHERLANDS</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-9"><img src="/resources/img/l91.jpg" alt="Odyssey"></div>
	...
	<!-- //Locations -->
<!--//NEWS-->
<div class="w3-agile-news" id="news">
	<div class="w3-agile-news-grids">
		<div class="col-md-6 w3-news-grid1-left">
			<h3>TOURIST</h3>
			<h3>News</h3>
		</div>
	...
	<div class="w3l-news-bottom">
		<div class="col-md-7 w3l-news-bottom-left">
			<div class="w3l-news-bottom-left-info">
				<h6><a href="#" data-toggle="modal" data-target="#myModal1">26 march 2017</a></h6>
				<h3><a href="#" data-toggle="modal" data-target="#myModal1">Our joyfull trip</a></h3>
				<p>Vestibulum vestibulum risus ac eros luctus, at dapibus libero gravida. Cras euismod, felis non egestas gravida, nisi purus placerat lacus, sed pulvinar ipsum turpis sed risus.</p>
			</div>
		</div>
		<div class="col-md-5 w3l-news-bottom-right">
			<img src="/resources/img/news-3.jpg" alt="" />
			<h6><a href="#" data-toggle="modal" data-target="#myModal2">26 march 2017</a></h6>
			<h3><a href="#" data-toggle="modal" data-target="#myModal2">Our joyfull trip</a></h3>
			<p>Vestibulum vestibulum risus ac eros luctus, at dapibus libero gravida. Cras euismod, felis non egestas gravida, nisi purus placerat lacus, sed pulvinar ipsum turpis sed risus.</p>
		</div>
		<div class="clearfix"> </div>
	</div>
...
<!-- Calendar -->
	...
	<!-- Portfolio-Popup-Box-JavaScript -->
		...
		<!-- Tour-Locations-JavaScript -->
			...
			<script src="/resources/js/grid3d.js"></script>
			<script>
...
<footer class="py-sm-5">
		<div class="container">
				<div class="row py-5">
						...
						<!-- //footer gri12 -->
						<!-- footer grid2 -->
						<div class="col-lg-4  footv3-left text-center my-lg-0 my-5"><br>
								<h3 class="mb-3">Get In Touch</h3><br>
								<p>S TRIP you can travel anywhere</p>
								...
								<div class="fv3-contact">
										...
										<p><a href="mailto:example@email.com">info@example.com</a>
										</p>
								</div>
						</div>
						<!-- //footer grid2 -->
						<!-- footer grid3 -->
						<div class="col-lg-4  footv3-left text-center"><br>
								<h3 class="mb-3">Navigation</h3><br>
								<ul class="list-agileits">
										...
										<ul class="mb-3"><a href="contact.html">패키지 여행</a>
										</ul>
										<ul>
				...
				<!-- //footer row -->
				<div class="cpy-right text-center pb-sm-0 pb-5"><br>
