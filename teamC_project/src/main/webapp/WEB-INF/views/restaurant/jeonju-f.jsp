		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/전주-맛집1.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">전라도음식이야기</h2>
						<p>한옥 양식으로 지은 2층 건물의 모습이 향토적인 느낌이 드는 한식당입니다. 4인 기준으로 구성한 한 상차림
							전라도식 한정식을 만날 수 있는데요, 영양죽, 샐러드, 떡갈비, 삼합, 잡채, 전 등 십여 가지 요리를 포함한 메뉴가
							가격대별로 준비되어 있습니다.</p>
					</div>
				</div>
				<hr>
				...
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/전주-맛집2.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">예지촌</h2>
						<p>생강청, 매실청 등 천연재료를 넣어 만드는 한정식이 유명한 곳입니다. 반찬을 따로 판매도 하고 있는
							곳입니다. 전주 완산구청 후문 식당거리에 자리 잡고 있습니다. 새우와 브로콜리가 들어간 계란찜 반찬도 인기가
							좋습니다. 이 외에도 청국장, 새우탕 등 30여 가지 반찬이 제공되는 예지 정식이 대표 메뉴입니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/전주-맛집3.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">현대옥전주본점</h2>
						<p>전주 콩나물국밥으로 유명한 콩나물국밥 전문점의 본점입니다. 메뉴로는 끓이지 않고 말아내어 수란을 함께
							제공하는 방식인 전주남부시장식 콩나물국밥과 계란을 뚝배기 속에 넣고 끓이는식의 콩나물국밥이 있습니다. 콩나물 국밥에는
							삶아 썰은 오징어를 추가할 수 있습니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/전주-맛집4.JPG"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">한일관</h2>
						<p>전주 한일관은 1954년 전주 남부시장에서 한일옥으로 창업하여 1960년부터 1990년대에 걸쳐 전주의
							대중음식점으로 전성기를 이루었고 전주에서는 가장 오랜 역사와 전통을 지닌 음식점입니다. 콩나물 국밥을 비롯하여
							비빔밥과 한일관 정식을 주로 하고 있습니다. 콩나물 국밥은 푸짐하게 얹어진 콩나물에 새우젓, 다진 파 그리고 깨소금을
							얹어 시원한 맛이 일품입니다. 비빔밥은 찹쌀 고추장과 각종 나물 고명을 얹어 비빈 것이 감칠맛을 냅니다.</p>
					</div>
				</div>
				<hr>
			</div>
