		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/중국-맛집1.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">전취덕</h2>
						<p>140년 역사를 자랑하는 베이징 카오야 대명사인 곳. 중국을 방문하는 유명인사들은 모두 한번쯤은 들를정도로
							유명한 식당이다. 김정일이 2004년 방문할때 영업을 중단해 줄것을 요청했으나 거절당한 일화가 있다. 전취덕은
							베이징에만 3개의 매장이 있는데 천문다제에 있는 본점이 가장 유명하다.</p>
					</div>
				</div>
				<hr>
				<!-- Second Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/중국-맛집2.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">난샹 구이위엔 찬팅</h2>
						<p>130년 전통 샤오룽바오 원조집으로 유명한곳입니다. 역사가 있는 만큼 맛있는곳이라 상하이 여행중 한번은 꼭
							들러야할 맛집입니다.</p>
					</div>
				</div>
				<hr>
				...
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/중국-맛집3.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">푸해휘</h2>
						<p>현대적인 감각으로 중국음식을 재해석한 채식주의자를 위한 레스토랑이다. 고기를 사용하지 않고 타로, 연꽃
							씨앗, 롱간과일과 홋카이도 팥 등을 사용해 요리를 만든다. 루의 요리는 고기의 부재에 대한 우려를 없앨만큼 강렬한
							요리들을 선보인다.</p>
					</div>
				</div>
				<hr>
				...
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/중국-맛집4.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">남상만두</h2>
						<p>남상만두(南翔小籠包)는 지금까지 백여년의 유구한 역사를 갖고 있는 상해시의 미식이다. 상하이 여행 필수
							코스이자 중국을 대표하는 정원 '예원' 내에 위치한 만두 맛집으로 많은 관광객들이 찾는 명소다. 육즙이 꽉 찬 딤섬에
							빨대를 꽂아 먹는 빨대 만두부터 튀김 만두까지 다양한 만두를 골라먹는 재미가 있다.</p>
					</div>
				</div>
				<hr>
			</div>
