		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/독일-맛집1.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">할라리</h2>
						<p>100년이 넘는 세월 동안 변치 않는 모습과 맛으로 뮌헨 시민들에게 사랑받는 음식점입니다. 사냥 용어에서
							따온 가게 이름답게 사슴, 오리, 거위, 야생 조류 등으로 음식 종류가 주종을 이룹니다. 주머니가 가벼운 여행자들은
							저녁보다 점심 시간대를 이용하는 편이 좋습니다.</p>
					</div>
				</div>
				<hr>
				<!-- Second Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/독일-맛집2.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">라츠켈러</h2>
						<p>독일 각 도시의 시청 건물에는 대규모 식당이 자리하고 있습니다. 라츠켈러(Ratskeller)라는 이름도
							시청(Rathaus)과 (술)저장고(Keller)에서 왔지요. 구시청사에 자리잡고 있는 뮌헨의 라츠켈러는 독일의 많은
							라츠켈러 중 첫손 꼽히는 곳입니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/독일-맛집3.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">Paulaner am Dom</h2>
						<p>독일 전통 음식과 맥주를 비싸지 않은 가격에 즐길 수 있는 곳으로 대성당 인근에 위치하고 있다.
							버거에서부터 소세지, 독일식 족발과 잘 어울리는 현지식 양배추 김치인 자우어크라우트(SAUERKRAUT)가 인기가
							있다.</p>
					</div>
				</div>
				<hr>
				...
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/독일-맛집4.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">카페 리샤르트</h2>
						<p>뮌헨 시내 곳곳에서 만날 수 있는 제과점·카페 체인. 달콤한 케이크와 커피 한잔하며 여행중의 피로를
							풀기에도 좋은 곳입니다. 아침에는 간단한 아침식사도 가능. 마리엔광장에서도 쉽게 찾을 수 있습니다.</p>
					</div>
				</div>
				<hr>
			</div>
