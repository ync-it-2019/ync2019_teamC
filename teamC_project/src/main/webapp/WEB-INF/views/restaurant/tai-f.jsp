		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row blogu">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/태국-맛집1.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">싸바이짜이</h2>
						<p>까이 양은 바삭한 껍질과 부드러운 속살을 자랑하며 함께 제공되는 양파 튀김을 곁들여먹으면 고소하고 부드러운
							맛이 배가 된다. 쏨땀(Somtam) 역시 이 집의 대표 메뉴 중 하나인데 정통의 맛을 고수하기 보다는 여행자들의
							입맛에 맞게 많이 순화되어 있다. 하지만 그 맛 또한 훌륭하며 매콤하고 강한 향이 적어 태국 음식을 처음 접하는
							사람에게는 오히려 편하게 먹을 수 있는 무난한 맛을 가지고 있다.</p>
					</div>
				</div>
				<hr>
				<!-- Second Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4 ">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/태국-맛집2.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">팁싸마이</h2>
						<p>팁 싸마이(Thip Samai)는 팟타이계의 전설이라고 불릴 정도로 최고의 팟타이를 선보이는데
							1966년부터 시작해 50년이 넘도록 최고의 자리를 유지하고 있다. 총 8가지 다양한 형태의 팟타이를 맛볼 수
							있으며, 오므라이스처럼 팟타이를 계란으로 덮은 형태의 슈퍼 팟타이 (Superb Phad Thai)가 제일 인기가
							좋다.</p>
					</div>
				</div>
				<hr>
				...
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/태국-맛집3.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">반쿤매</h2>
						<p>깔끔한 분위기의 레스토랑으로 다양한 태국 음식을 맛볼 수 있다. 외국인 여행자들이 많이 찾아오는 곳으로
							향신료가 강하지 않아 태국 음식을 처음 먹는 사람도 거부감없이 먹을 수 있다. 메뉴에는 커리, 볶음밥, 누들, 튀김
							요리, 열대과일 음료 등이 다양하게 준비되어 있습니다.</p>
					</div>
				</div>
				<hr>
				<!-- Third Blog Post -->
				<div class="row">
					<div class="col-sm-4 col-md-4">
						<div class="blog-thumb">
							<img class="img-responsive" src="/resources/img/태국-맛집4.jpg"
								alt="photo">
						</div>
					</div>
					<div class="col-sm-8 col-md-8">
						<h2 class="blog-title">사보이 씨푸드</h2>
						<p>오픈 키친으로 위생과 맛 모두 만점! 뛰어난 접근성으로 여행객들에게 사랑받는 곳</p>
					</div>
				</div>
				<hr>
			</div>
