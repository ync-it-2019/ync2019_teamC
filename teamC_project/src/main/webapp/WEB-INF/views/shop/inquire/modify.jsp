        ...
        <div class="col-md-8 inbox_right">
        	<div class="Compose-Message">
                <div class="panel panel-default">
                    ...
                    <form role ="form" action = "/shop/inquire/modify" method = "post">
                        <div class="alert alert-info">
                            상품문의 수정
                        </div>
                        <hr>
                       <label>제목</label> <input class="form-control1 control3" name='title'
                       value='<c:out value="${inquire.title }"/>'>
                        ...
                        <c:out value="${inquire.content}" /></textarea>
                        <hr>
                        <hr>
...
$(document).ready(function() {
	  ...
	  $('button').on("click", function(e){
	    ...
	    if(operation === 'remove'){
	      formObj.attr("action", "/shop/inquire/remove");
